...
flowchart TD
    A([Start: Population]) --> B[Genetic Variation Occurs];
    B --> C{Is the variation advantageous for survival?};
    C -->|Yes| D[Natural Selection Favors Trait];
    D --> E[Organism Survives & Reproduces More];
    E --> F[Advantageous Trait is Inherited by Offspring];
    F --> G([Evolution: Trait becomes more common]);
    C -->|No / Neutral| H[Trait Does Not Provide an Advantage];
    H --> I([Trait remains rare or disappears]);
